  ...
  return (
    <nav className='flex-between w-full mb-16 pt-3'>
      ...
      <div className='sm:flex hidden'>
        {session?.user? (
          <div className='flex gap-3 nd:gap-5'>
        ...
        {session?.user? (
            <div className='flex'>
              <Image src={session?.user.image} width={37} height={37}
                className='rounded-full' alt="profile" onClick={() => setToggleDropdown(!toggleDropdown)} />

              {
                toggleDropdown &&
                (<div className='dropdown'><Link href="/profile" className='dropdown_link'
